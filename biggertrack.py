...
if __name__ == '__main__':
    ...
    for i in range(len(x_inner)):
        ...
        x_inner_limit.append(x_inner[i]-direction[0]*20/size)
        x_outer_limit.append(x_outer[i]+direction[0]*20/size)
        y_inner_limit.append(y_inner[i]-direction[1]*20/size)
        y_outer_limit.append(y_outer[i]+direction[1]*20/size)
